...
public class Quiz implements ActionListener{
	...
	char[] answers = question.getAnswers();
	
	char answer; // Raspunsul oferit
	int index; // Indexul intrebarii
	int correct_guesses = 0; //Numarul de raspunsuri corecte oferite
	int total_questions = questions.length;// Numarul total de intrebari 
	int result; // Rezultatul
	int seconds = 10; // Timpul oferit pentru a raspunde la o intreabre(in secunde)
